...
async function submitFromBuilder() {
  ...
  if (b._addVariantFor) {
    try {
      ...
      const { renderRightPanel } = await import("./chunk-FLOY2LJV.js");
      const { syncAttributionOverlay } = await import("./chunk-VPHDRIDO.js");
      const { applyShellTheme, applyPreview } = await import("./chunk-RXYIQ4OH.js");
