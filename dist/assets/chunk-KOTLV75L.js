...
async function showAchievements() {
  ...
  if (leaderboardVisible) {
    const { hideLeaderboard } = await import("./chunk-W3JMDQA6.js");
    hideLeaderboard();
  }
  ...
  const BADGE_ICONS = {
    buy_coffee: "\u2615",
    create_theme: "\u{1F3A8}",
    share_x: "\u{1F4E3}",
    sign_in: "\u{1F498}",
    like_theme: "\u2764\uFE0F",
    top10_monthly: "\u{1F3D4}\uFE0F",
    use_api: "\u{1F9F1}",
    color_me_lucky: "\u{1F308}",
    agent_use: "\u{1F916}",
    install_pwa: "\u{1F4F1}",
    complete_pair: "\u262F\uFE0F",
...
function closeAchievements() {
  ...
  win.style.display = "";
  if (!leaderboardVisible) previewArea?.classList.remove("preview-area--detail");
}
