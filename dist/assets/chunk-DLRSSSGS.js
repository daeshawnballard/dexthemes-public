...
async function checkOnboarding() {
  ...
  if (window.innerWidth > 1024) {
    ...
    if (showcase) {
      const actions = await import("./chunk-RSQ57V2X.js");
    ...
    if (communityThemes.length > 0) {
      ...
      if (savedId && selectedTheme.id !== savedId) {
        ...
        if (restored) {
          ...
          const { applyShellTheme: applyShellTheme2, applyPreview: applyPreview2 } = await import("./chunk-RXYIQ4OH.js");
          const { syncAttributionOverlay: syncAttributionOverlay2 } = await import("./chunk-RSQ57V2X.js");
