...
import {
  applyPreview,
  applyShellTheme
} from "./chunk-NGGIQU5Q.js";
import "./chunk-UKA2Y5Q6.js";
import {
  grantUnlockAction
} from "./chunk-BJMA4MQH.js";
import "./chunk-HYGEL7FM.js";
...
async function dispatchAction(action, element, event) {
  switch (action) {
    ...
    case "builder-mobile-submit":
      return import("./chunk-OGDJKKNM.js").then((m) => m.mobileStartSubmit());
    case "dismiss-coc":
    ...
    case "builder-submit":
      return import("./chunk-JYPQXKAB.js").then((m) => m.submitFromBuilder());
    ...
    case "submit-json-close":
      return import("./chunk-JYPQXKAB.js").then((m) => m.dismissSubmitJsonModal());
    case "submit-json-confirm":
      return import("./chunk-JYPQXKAB.js").then((m) => m.submitJsonFromModal());
    case "dismiss-mobile-submit":
      return import("./chunk-OGDJKKNM.js").then((m) => m.dismissMobileSubmitModal());
    case "do-mobile-submit":
      return import("./chunk-OGDJKKNM.js").then((m) => m.mobileDoSubmit());
    case "report-theme-name":
      return import("./chunk-VPHDRIDO.js").then((m) => m.reportThemeName());
    case "confirm-report-theme-name":
      return import("./chunk-VPHDRIDO.js").then((m) => m.confirmThemeNameReport());
    case "cancel-report-theme-name":
      return import("./chunk-VPHDRIDO.js").then((m) => m.cancelThemeNameReport());
    ...
    case "run-unlock-action":
      return import("./chunk-42J4XRN5.js").then((m) => m.onUnlockAction(element.dataset.unlockAction || ""));
    case "run-api-unlock":
    ...
    case "dismiss-supporter-prompt":
      return import("./chunk-42J4XRN5.js").then((m) => m.dismissSupporterPrompt());
    default:
      return void 0;
  }
}
...
async function ensurePreviewChatInitialized() {
  ...
  const { initPreviewChat } = await import("./chunk-W3BZNAVJ.js");
  initPreviewChat();
...
async function initDesktopPreviewShell() {
  ...
  const attribution = await import("./chunk-VPHDRIDO.js");
  attribution.syncAttributionOverlay();
  const chat = await import("./chunk-W3BZNAVJ.js");
